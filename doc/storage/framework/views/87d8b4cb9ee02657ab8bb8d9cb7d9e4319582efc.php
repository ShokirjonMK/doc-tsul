							...
							<?php endif; ?>
								<tr class="<?php echo e($item->statusclass); ?>">
									...
									<td>
										...
										<?php echo e(\Illuminate\Support\Str::limit($item->department->name, 150, $end='...')); ?>
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/doc/resources/views/mk/pages/user/index.blade.php ENDPATH**/ ?>